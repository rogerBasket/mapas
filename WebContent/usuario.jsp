			...
			<div id="texto">
				<div id="paginas">
					<div class="caja">
						...
						%>
						<h4><%=usuario.getUser() %></h4>
						<ul class="blocklist">
							<li><a href="NuevoMapaJSP">Crear Mapa</a></li>
							<li><a href="ListarMapasAction">Listar Mapas</a></li>
							<li><a href="ContribucionesAction">Contribuciones</a></li>
							<li><a href="PerfilJSP">Perfil</a></li>
						</ul>
					</div>
				</div>	
			</div>
